...
fun lastNumberSpoken(startingNumbers: IntArray, totalNumbers: Int): Int {
  ...
  for (i in startingNumbers.size until totalNumbers) {
    val nextNumber = spokenNumbers[lastSpoken]?.let { i - it - 1 } ?: 0
