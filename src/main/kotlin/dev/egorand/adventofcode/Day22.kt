...
fun crabCombat(cards: String): Long {
  val lines = cards.lines()
  val player1Cards = LinkedList<Int>()
  val player2Cards = LinkedList<Int>()
  var lineIndex = 1
  for (i in lineIndex until lines.size) {
    ...
    player1Cards.addLast(lines[i].toInt())
  }
  for (i in lineIndex until lines.size) {
    player2Cards.addLast(lines[i].toInt())
  }
  return crabCombat(player1Cards, player2Cards)
}

fun crabCombat(player1Cards: Deque<Int>, player2Cards: Deque<Int>): Long {
  fun calculateScore(cards: Collection<Int>): Long {
  ...
  while (player1Cards.isNotEmpty() && player2Cards.isNotEmpty()) {
    val player1Card = player1Cards.removeFirst()
    val player2Card = player2Cards.removeFirst()
    when {
  ...
  return calculateScore(if (player1Cards.isNotEmpty()) player1Cards else player2Cards)
}
